...
namespace AlgorithmsPractice.Test
{
    public class FibonacciTest
    {
        ...
        [TestCase(0UL, 0UL)]
        [TestCase(1UL, 1UL)]
        public void Fib_Tabulated_Default(ulong nth, ulong expected)
        {
            Assert.AreEqual(_fibonacci.Tabulated(nth), expected);
        }
        ...
        [TestCase(9UL, 34UL)]
        [TestCase(50UL, 12586269025UL)]
        public void Fib_Tabulated_Of_Nath(ulong nth, ulong expected)
        {
            Assert.AreEqual(_fibonacci.Tabulated(nth), expected);
        }
    }
